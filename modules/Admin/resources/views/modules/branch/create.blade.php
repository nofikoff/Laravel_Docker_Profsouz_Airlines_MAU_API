        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <strong>{{ trans('admin::branch.create-title') }}</strong>
                </div>
                <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="text-input" name="name" class="form-control"
                                       placeholder="{{ trans('admin::branch.name-pl') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label"
                            ...
                            <div class="col-md-9">
                                <textarea id="textarea-input" name="description" rows="7" class="form-control"
                                          placeholder="{{ trans('admin::branch.description-pl') }}..."></textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9 pt-2">
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input class="form-check-input" name="is_inherit" type="checkbox"
                                               id="checkbox-inherit"
                                               value="1">
                                    </label>
                                </div>
                    ...
                    <div class="card-footer">
                        <button class="btn btn-sm btn-success">
                            <i class="fa fa-dot-circle-o"></i> {{ trans('admin::branch.create') }}
                        </button>
