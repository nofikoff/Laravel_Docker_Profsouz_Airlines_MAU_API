        ...
        <div class="col-6 offset-3">
            <div class="card">
                <div class="card-header">
                    <strong>{{ trans('admin::finn_types.header') }}</strong>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                                <input type="text" id="input-en" name="en" class="form-control"
                                       value="{{ $type->en }}" placeholder="EN">
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-sm btn-primary">
                            <i class="fa fa-dot-circle-o"></i> {{ trans('admin::finn_types.submit') }}
                        </button>
                        <button type="reset" class="btn btn-sm btn-danger">
                            <i class="fa fa-ban"></i> {{ trans('admin::finn_types.reset') }}
                        </button>
                    </div>
                </form>
            </div>
